<template>
  <el-dialog v-loading="dialogLoading" title="添加奖励信息" :width="dialogWidth" :visible.sync="visible" :show-close="false" :close-on-click-modal="false" :close-on-press-escape="false">
