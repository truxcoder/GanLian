<template>
  <el-dialog v-loading="dialogLoading" title="编辑奖励信息" :width="dialogWidth" :visible.sync="visible" :show-close="false" :close-on-click-modal="false" :close-on-press-escape="false">
