<!--
 * @Author: truxcoder
 * @Date: 2022-04-19 17:26:27
 * @LastEditTime: 2022-04-19 17:26:28
 ...
 * @LastEditTime: 2022-04-19 17:15:04
 * @LastEditors: truxcoder
  ...
  <el-dialog v-loading="dialogLoading" :title="actName + '人员角色信息'" :width="dialogWidth" :visible.sync="visible" :show-close="false" :close-on-click-modal="false" :close-on-press-escape="false">
    ...
    >
      <el-form-item label="姓名" prop="personnelId">
        ...
        <!-- <PersonnelOption v-model="form.personnelId" :rowdata="personnelOption" :is-update="action === 'update'" :form-item-width="formItemWidth" /> -->
        <AccountOption v-model="form.personnelId" :row="personnelOption" :is-update="action === 'update'" :width="formItemWidth" />
      </el-form-item>
