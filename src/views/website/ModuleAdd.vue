 ...
 * @LastEditTime: 2022-01-26 21:06:40
 * @LastEditors: truxcoder
 * @Description:
-->
<template>
  <el-dialog v-loading="dialogLoading" title="添加模块" :visible.sync="visible" :width="dialogWidth" :show-close="false" :close-on-click-modal="false" :close-on-press-escape="false">
    <el-form ref="addForm" :inline="true" :model="form" :rules="rules" size="medium" label-position="right" class="moduleForm">
