<template>
  <el-dialog v-loading="dialogLoading" title="编辑职务信息" :width="dialogWidth" :visible.sync="visible" :show-close="false" :close-on-click-modal="false" :close-on-press-escape="false">
