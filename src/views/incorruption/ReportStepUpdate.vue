 ...
 * @LastEditTime: 2022-02-17 11:29:39
 * @LastEditors: truxcoder
 * @Description: 修改举报步骤信息
-->
<template>
  <el-dialog
  ...
  watch: {
    visible: function(val, oldval) {
      if (val === true) {
        ...
        this.stepForm = { ...this.currentData[this.index] }
      } else {
        this.currentData = []
      }
    }
    ...
    onSubmit() {
      this.$refs.addForm.validate(valid => {
        if (valid) {
          ...
          this.currentData[this.index] = this.stepForm
