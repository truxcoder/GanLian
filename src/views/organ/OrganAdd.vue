<template>
  <el-dialog v-loading="dialogLoading" title="添加机构信息" :width="dialogWidth" :visible.sync="formVisible" :show-close="false" :close-on-click-modal="false" :close-on-press-escape="false">
...
<script>
import { organAdd } from '@/api/organ'
    ...
    onSubmit() {
      this.$refs.addForm.validate(valid => {
        if (valid) {
          ...
          organAdd(this.form).then(response => {
            this.$message({
